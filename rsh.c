...
int main(int argc, char **argv) {
		...
		while (1) {
		  	fprintf(stderr,"rsh>");
			if (fgets(line,256,stdin)==NULL) { continue;}																																					if (strcmp(line,"\n")==0) {continue;}
			...
			if (!isAllowed(cmd)) { 			  
				...
				// and the message should be "hello there"
		 		...
		 		// if no message is specified, you should print the following												 		// printf("sendmsg: you have to enter a message\n");
